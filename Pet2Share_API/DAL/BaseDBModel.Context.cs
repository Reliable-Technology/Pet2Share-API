...
public partial class Pet2ShareEntities : DbContext
{
    ...
    public virtual int DeletePost(Nullable<int> id, Nullable<int> postedBy, Nullable<bool> isPostByPet)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("DeletePost", idParameter, postedByParameter, isPostByPetParameter);
    }


    public virtual int DeleteUserComment(Nullable<int> id, Nullable<int> userId)
    {
